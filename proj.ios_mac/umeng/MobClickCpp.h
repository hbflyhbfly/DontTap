...
namespace umeng {
    ...
    public:
        ...
        static void eventWithAttributesString(const char * eventId, const char * attributes);
        ...
        static void event(const char * eventId, eventDict * attributes) {
            ...
            eventWithAttributesString(eventId, attributesStr.c_str());
        }
        ///---------------------------------------------------------------------------------------
        /// @name  页面计时
        ///---------------------------------------------------------------------------------------
        ...
        UMENG_DEPRECATED static void setUserInfo(const char * userId, Sex sex, int age, const char * platform);
        ...
        /*适配cocos2dx3.8及以上版本在Android平台session统计*/
        static void setSeesionAdapt(bool value);
    };
...
#if (defined(COCOS2D_VERSION)&&COCOS2D_VERSION>=0x00030000)
            string cVersion("cocos2d-x-3.8");
            if(COCOS2D_VERSION>0x00030700||(COCOS2D_VERSION==0x00030700&&cVersion==cocos2dVersion())){
                umeng::MobClickCpp::setSeesionAdapt(true);
            }
